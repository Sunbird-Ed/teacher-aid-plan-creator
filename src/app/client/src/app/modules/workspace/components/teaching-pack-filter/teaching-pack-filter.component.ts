...
@Component({
  selector: 'app-teaching-pack-filter',
  templateUrl: './teaching-pack-filter.component.html',
  styles: [`
     >>> .ui.dropdown:not(.button)>.default.text {
      ...
      .popup-content{
       ...
       ::ng-deep .teaching-pack-filters sui-multi-select#resourceType {
        display:none !important;
       }
   `]
})
export class TeachingPackFilterComponent implements OnInit {
 ...
 */
  ...
  public handleSearch() {
    ...
    this.route.navigate(['workspace/content/teachingpack', 1], { queryParams: this.queryParams});
  }
  keyup(event) {
    this.query = event;
